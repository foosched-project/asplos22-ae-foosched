...
#define EXPORT_SIDECAR(fn, file, ...) EXPORT_FOOSCHED(fn, __VA_ARGS__)
#define EXPORT_CALLBACK EXPORT_FOOSCHED
#define EXPORT_FOOSCHED(fn, ...) NR_##fn,
enum {
	#include "export_jump.h"
	NR_INTERFACE_FN
} nr_inter_fn;
#undef EXPORT_FOOSCHED
...
#define EXPORT_FOOSCHED(fn, ret, ...) extern ret fn(__VA_ARGS__);
#include "export_jump.h"
#undef EXPORT_FOOSCHED
#undef EXPORT_CALLBACK
...
#define EXPORT_FOOSCHED(fn, ret, ...) extern ret __orig_##fn(__VA_ARGS__);
#include "export_jump.h"
#undef EXPORT_FOOSCHED
#undef EXPORT_CALLBACK
...
#define EXPORT_FOOSCHED(fn, ...) DEFINE_JUMP_FUNC(fn);
#include "export_jump.h"
#undef EXPORT_FOOSCHED

#define EXPORT_FOOSCHED(fn, ...) JUMP_INSTALL_FUNC(fn);
...
#define EXPORT_FOOSCHED(fn, ...) JUMP_REMOVE_FUNC(fn);
...
#define EXPORT_FOOSCHED(fn, ...) JUMP_INIT_FUNC(fn, );
