...
def func_class_arithmetics(fns):
    """Core algorithm of foosched. Set operations and graph theory."""
...
if __name__ == '__main__':
    ...
    export = "EXPORT_FOOSCHED({fn}, {ret}, {params})\n"
    mod_fmt = '__mod_{}\n'
    unds, taints = [], []
